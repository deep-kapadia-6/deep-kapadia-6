...
### [RNA-SeqEasy](https://github.com/deep-kapadia-6/RNA-SeqEasy)
[![Live Demo](https://img.shields.io/badge/Demo-Live-brightgreen)](https://rnaseqeasy.streamlit.app/)
...
Desktop app for randomized workout routine generation.

## 🛠️ Technical Skills

**Languages:** Python, R, Shell scripting  
**Bioinformatics:** Scanpy, Seurat, Cell Ranger, CellTypist, scVI-tools  
**ML/Data Science:** scikit-learn, PyTorch, pandas, NumPy  
**Web Development:** Streamlit, FastAPI, Flask  
**DevOps:** Docker, Git, HTCondor, Nextflow  
...
<!--
**deep-kapadia-6/deep-kapadia-6** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
